...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.9]
        ...
        \begin{axis}[
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{Graf povprečij največje netrivialne lastne vrednosti \(5\)-regularnih grafov v odvisnosti od števila vozlišč}
        \label{fig:5-regular}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.9]
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Graf povprečij največje netrivialne lastne vrednosti \(11\)-regularnih grafov v odvisnosti od števila vozlišč}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.9]
        ...
        \begin{axis}[
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{Graf povprečij največje netrivialne lastne vrednosti \(21\)-regularnih grafov v odvisnosti od števila vozlišč}
