...
\kljucnebesede{Ramanujanovi grafi\sep prepletene družine\sep Ramanujanova domneva\sep Ihara zeta funkcija}

% - angleški prevod ključnih besed
\keywords{Ramanujan graphs\sep interlacing families\sep Ramanujan conjecture\sep Ihara zeta function}
...
\programdela{
  V delu raziščite koncept Ramanujanovih grafov. Definirajte osnovne pojme v zvezi z ekspanzivnostjo in predstavite Ramanujanove grafe kot optimalne grafe glede na ta koncept. Z računalnikom eksperimentalno preverite, kolikšen delež naključnih grafov je Ramanujanovih. Predstavite naključno konstrukcijo neskončne družine Ramanujanovih grafov, ki temelji na prirejanjih v grafih in realno stabilnih polinomih. Prikažite tudi slovito eksplicitno konstrukcijo Ramanujanovih grafov s pomočjo Cayleyjevih grafov matričnih grup in elementarne teorije števil. Nazadnje razložite še vlogo teh objektov v grafovski različici Riemannove hipoteze.
}
...
% ukaz \vnosliterature, v katerega vpišemo citat
  ...
  \vnosliterature{huang2024ramanujanpropertyedgeuniversality}
}
